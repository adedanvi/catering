    ...
    <nav class="navbar navbar-default navbar-fixed-top navbar-blue">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#">Bakol Catering Online</a>
        </div>
        ...
        <!-- Wrapper for Slides -->
          <div class="carousel-inner">
            ...
            <div class="item">
                ...
                <div class="fill" style="background-image:url('<?php $url ?>assets/img/wel.png');"></div>
                <div class="carousel-caption">
                    <h2>B A C O L</h2>
                </div>
            </div> 
	...
	<div class="row">
		<div class="col-md-3">
			...
			<div class="row col-md-12">
				...
				<img src="<?php echo $url.'assets/img/wel.png'; ?>" width="100%">
			</div>
		</div>